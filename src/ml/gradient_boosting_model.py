"""
Gradient Boosting model for DGA detection.
...
class GradientBoostingDGADetector:
    """
    Gradient Boosting-based DGA detector.
    ...
    def __init__(
        ...
        """
        Initialize the Gradient Boosting DGA detector.

        Args:
            n_estimators: Number of boosting stages
            max_depth: Maximum depth of individual trees (lower than RF)
    ...
    def train(
        ...
        # Store number of estimators used (may be less due to early stopping)
        self.n_estimators_used = self.model.n_estimators_
        ...
        if validate:
            ...
            self.metrics['n_estimators_used'] = self.n_estimators_used
            ...
            print(f"  Estimators used: {self.n_estimators_used}")
